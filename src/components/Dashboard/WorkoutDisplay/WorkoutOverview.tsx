	...
	return (
		<div className="flex flex-col gap-10 h-full">
			...
			<div className="flex flex-col">
				...
				<div className="font-bold text-6xl underline">{workout && workout.name.toUpperCase()}</div>
			</div>
			<div className="flex flex-col gap-2">
				<span className="font-bold text-2xl">
					<span className="text-5xl font-black underline">{workout && workout.exercises.length}</span> exercises to be done
				</span>
				<span className="font-bold text-2xl">
					<span className="text-5xl font-black underline">{workout && aggregateMuscles(workout).length}</span> muscle groups worked
				</span>
			</div>
			<div className="flex flex-col gap-2">
